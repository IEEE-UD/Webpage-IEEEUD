  ...
  _createClass(Parallax, [{
    ...
    value: function getCache() {
      ...
      this.dom.divs.forEach(function (el, index) {
        ...
        if (index === 4) {
          ...
          //console.log(bounding.top, scrollY, bounds.top);
            ...
            console.log('scrollY : '+bounds.top);
      ...
      // get bounding value based on the container (.vs-section) height
        ...
        //console.log(this.vars.bounding);
    }
  }, {
    key: 'run',
    value: function run() {
...
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
    ...
    //DOT 
    // à commenter si on ne veut pas le paralaxe.
...
VirtualScroll.prototype._onWheel = function(e) {
    ...
    //REVERSE SCROLL TO HORIZONTAL
    // if(Math.abs(e.wheelDeltaY)>Math.abs(e.wheelDeltaX)) evt.deltaX = evt.deltaY;
    if(Math.abs(e.deltaY)>Math.abs(e.deltaX)) evt.deltaX = evt.deltaY;
...
VirtualScroll.prototype._onTouchMove = function(e) {
    ...
    //REVERSE SCROLL TO HORIZONTAL
    if(Math.abs(evt.deltaX)>Math.abs(evt.deltaY)) evt.deltaY = evt.deltaX;
